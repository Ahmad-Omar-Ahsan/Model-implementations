...
class Config:
    def __init__(self):
        ...
        self.checkpoint_gen_a = "CycleGAN/ckpts/new_ckpt/gena.pth.tar"
        self.checkpoint_gen_b = "CycleGAN/ckpts/new_ckpt/genb.pth.tar"
        self.checkpoint_dis_a = "CycleGAN/ckpts/new_ckpt/disa.pth.tar"
        self.checkpoint_dis_b = "CycleGAN/ckpts/new_ckpt/disb.pth.tar"
