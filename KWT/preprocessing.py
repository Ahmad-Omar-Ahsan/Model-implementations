...
def get_mfccs_augmented(file_path, data_dir='data'):
    """
...
def load_train_test_val_files(filenames, data_dir='data'):
    """
...
def load_data(train_files, test_files, val_files, commands, data_dir='data'):
    """
...
def collect_data(batch_size, data_dir='data'):
    """
